...
public class UserCacheImpl implements UserCache {
  ...
  private static final String DEFAULT_FILE_NAME = "url_";
    ...
    return Observable.create(new Observable.OnSubscribe<T>() {
      @Override public void call(Subscriber<? super T> _subscriber) {
        ...
        if (userEntity != null) {
          ...
          _subscriber.onError(new NullPointerException());
        }
      }
    });
  }
  ...
  @Override public boolean isCached(String urlKey) {
    File userEntitiyFile = this.buildFile(urlKey);
   ...
   *
   * @param urlKey The id user to build the file.
   * @return A valid file.
   */
  private File buildFile(String urlKey) {
